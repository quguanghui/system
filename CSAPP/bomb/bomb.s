...
0000000000400da0 <main>:
  400da0:	53                   	push   %rbx   # 入栈
  400da1:	83 ff 01             	cmp    $0x1,%edi # 比较main的第一个参数如果不是1 跳转到400db6 
  400da4:	75 10                	jne    400db6 <main+0x16> 
  400da6:	48 8b 05 9b 29 20 00 	mov    0x20299b(%rip),%rax        # 603748 <stdin@GLIBC_2.2.5>
  400dad:	48 89 05 b4 29 20 00 	mov    %rax,0x2029b4(%rip)        # 603768 <infile>
  400db4:	eb 63                	jmp    400e19 <main+0x79> # 初始化bomb 输入参数为1
  400db6:	48 89 f3             	mov    %rsi,%rbx # 将文件地址指针放入到rsi,
  400db9:	83 ff 02             	cmp    $0x2,%edi # 如果第一个参数不为2,跳转到400df8 退出
  400dbc:	75 3a                	jne    400df8 <main+0x58> # 输出并推出文件系统
  400dbe:	48 8b 7e 08          	mov    0x8(%rsi),%rdi # 第二个文件指针存在rdi中
  400dc2:	be b4 22 40 00       	mov    $0x4022b4,%esi
  400dc7:	e8 44 fe ff ff       	call   400c10 <fopen@plt>
  400dcc:	48 89 05 95 29 20 00 	mov    %rax,0x202995(%rip)        # 603768 <infile>
  400dd3:	48 85 c0             	test   %rax,%rax    # 如果rax为0则返回
  ...
  400e53:	48 89 c7             	mov    %rax,%rdi # 输入的参数为第一个参数
...
0000000000400ee0 <phase_1>:
  400ee0:	48 83 ec 08          	sub    $0x8,%rsp # 分配8byte空间
  400ee4:	be 00 24 40 00       	mov    $0x402400,%esi
  400ee9:	e8 4a 04 00 00       	call   401338 <strings_not_equal>
  400eee:	85 c0                	test   %eax,%eax # 如果返回值为0，返回爆炸？
  400ef0:	74 05                	je     400ef7 <phase_1+0x17>
  400ef2:	e8 43 05 00 00       	call   40143a <explode_bomb>
  400ef7:	48 83 c4 08          	add    $0x8,%rsp
  400efb:	c3                   	ret    

0000000000400efc <phase_2>:         # 此时输入在rdi中
  400efc:	55                   	push   %rbp
  400efd:	53                   	push   %rbx
  400efe:	48 83 ec 28          	sub    $0x28,%rsp # 栈空间为28
  400f02:	48 89 e6             	mov    %rsp,%rsi
  400f05:	e8 52 05 00 00       	call   40145c <read_six_numbers>
  400f0a:	83 3c 24 01          	cmpl   $0x1,(%rsp) # rsp内的值与1比较，相等跳转，不等就爆炸
  400f0e:	74 20                	je     400f30 <phase_2+0x34>
  400f10:	e8 25 05 00 00       	call   40143a <explode_bomb>
  400f15:	eb 19                	jmp    400f30 <phase_2+0x34>
  400f17:	8b 43 fc             	mov    -0x4(%rbx),%eax 
  400f1a:	01 c0                	add    %eax,%eax # 2 4
  ...
  400f30:	48 8d 5c 24 04       	lea    0x4(%rsp),%rbx # 将堆栈中的地址给rbx,02
  400f35:	48 8d 6c 24 18       	lea    0x18(%rsp),%rbp # 31
...
0000000000400f43 <phase_3>:
  400f43:	48 83 ec 18          	sub    $0x18,%rsp # input number is in rsi
...
0000000000400fce <func4>:
  ...
  400fd2:	89 d0                	mov    %edx,%eax  # e
  400fd4:	29 f0                	sub    %esi,%eax  # e
  400fd6:	89 c1                	mov    %eax,%ecx  # e
  400fd8:	c1 e9 1f             	shr    $0x1f,%ecx  # 0
  400fdb:	01 c8                	add    %ecx,%eax # e + 0 
  400fdd:	d1 f8                	sar    %eax   # 0011
  400fdf:	8d 0c 30             	lea    (%rax,%rsi,1),%ecx # ecx = 7
  400fe2:	39 f9                	cmp    %edi,%ecx # 7 - e 
...
0000000000401338 <strings_not_equal>:
  401338:	41 54                	push   %r12 //protect r12
  40133a:	55                   	push   %rbp //protect rbp
  40133b:	53                   	push   %rbx //protect rbx
...
000000000040143a <explode_bomb>: # 引爆炸弹
...
000000000040145c <read_six_numbers>: # 输入参数要大于6
  40145c:	48 83 ec 18          	sub    $0x18,%rsp # 给栈分配0x18大小
  401460:	48 89 f2             	mov    %rsi,%rdx 
  401463:	48 8d 4e 04          	lea    0x4(%rsi),%rcx # 将(rsi)+4的内存值放入rcx寄存器
  401467:	48 8d 46 14          	lea    0x14(%rsi),%rax  # 将(rsi)+14的内存值放入rax寄存器
  40146b:	48 89 44 24 08       	mov    %rax,0x8(%rsp)  # 将rax值存入栈中方
  401470:	48 8d 46 10          	lea    0x10(%rsi),%rax
  401474:	48 89 04 24          	mov    %rax,(%rsp)
  401478:	4c 8d 4e 0c          	lea    0xc(%rsi),%r9
  40147c:	4c 8d 46 08          	lea    0x8(%rsi),%r8
  401480:	be c3 25 40 00       	mov    $0x4025c3,%esi # %d %d %d %d %d %d
  401485:	b8 00 00 00 00       	mov    $0x0,%eax # 判断返回值时先清空rax
